...
export class ManagestreamrequestService {
  ...
  get_purchasePlans() {
    return this.http.get(this.baseurl + "/v1/purchaseplan/mypurchase/plans/gellall");
  }
  ...
  create_request_one_image(date: any, id: any) {
    return this.http.post(this.baseurl + "/v1/ecomplan/create/stream/one/image?id=" + id, date,);
  }
  create_request_one_video(date: any, id: any) {
    return this.http.post(this.baseurl + "/v1/ecomplan/create/stream/one/video?id=" + id, date);
  }
  ...
  get_all_request(page: any) {
    return this.http.get(this.baseurl + "/v1/ecomplan/get/all/stream?page=" + page);
  }
