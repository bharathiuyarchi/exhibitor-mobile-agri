...
export class CreatestreamrequestComponent implements OnInit {
  ...
  constructor(public api: ManagestreamrequestService, public router: Router, private route: ActivatedRoute) { }
  id: any;
  expire_date: any;
  now_date: any;
  ngOnInit(): void {
    ...
    if (this.id == null) {
      ...
      if (this.postRequest.valid && (this.selected_image != null && this.selected_image != 'invalid' && this.selected_video != null && this.selected_video != 'invalid' || this.id != null)) {
        let date = {
          ...
          streamingDate_time: this.postRequest.get('streamingDate_time')?.value,
        }
